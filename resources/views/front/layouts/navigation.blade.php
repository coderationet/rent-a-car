        ...
        <div class="flex-1 flex justify-start items-center">
            <ul class="flex flex-row items-center justify-center gap-7">
                <li class="flex justify-center items-center gap-1">
                    ...
                    <a href="tel:{{\App\Helpers\Option::get('phone_value')}}">{{\App\Helpers\Option::get('phone_text')}}</a>
                </li>
                <li class="flex justify-center items-center gap-1">
                    <img src="{{ asset('assets/img/icons8-whatsapp-24.png') }}" class="w-4 h-4"/>
                    <a href="{{\App\Helpers\Option::get('whatsapp_value')}}">{{\App\Helpers\Option::get('whatsapp_text')}}</a>
                </li>
